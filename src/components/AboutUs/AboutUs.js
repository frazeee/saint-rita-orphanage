              ...
              <div className="card shadow rounded mb-5">
                <div className="card-body text-center py-4 px-3">
                  <p className="mb-4">
                    ...
                    organization is devoted to protecting souls, valuing life,
                    and offering a temporary home where innocent children can
                    grow and flourish physically and spiritually through loving
                    care.
                  </p>
                  <p>
                    {" "}
                    Saint Rita Orphanage is accredited by the Department of
                    Social Welfare and Development (DSWD) and registered with
                    the Securities and Exchange Commission (SEC), relying solely
                    on donations from the public and corporations for support.
                  </p>
                </div>
              </div>
            </div>
